          ...
          <div className="hidden md:flex items-center gap-12">
            {[
              ...
              <button
                ...
                className={`font-label text-sm uppercase tracking-[0.2em] font-bold transition-all duration-500 hover:tracking-[0.3em] ${
        ...
        <div className="relative z-10 max-w-5xl mx-auto flex flex-col items-center gap-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[8px] uppercase tracking-[0.4em] text-secondary font-bold">
                Heritage Embroidery Atelier · JAMBUNATHAPURAM, Musiri
              </span>
            </div>
          </div>
